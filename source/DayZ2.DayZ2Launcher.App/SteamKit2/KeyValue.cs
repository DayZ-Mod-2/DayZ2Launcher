...
namespace SteamKit2
{
    ...
    public class KeyValue
    {
        ...
        /// <remarks>
        ///     This method will swallow any exceptions that occur when reading, use <see cref="ReadAsText" /> if you wish to
        ///     handle exceptions.
        /// </remarks>
        ...
        /// <returns>a <see cref="KeyValue" /> instance if the load was successful, or <c>null</c> on failure.</returns>
        /// <remarks>
        ///     This method will swallow any exceptions that occur when reading, use <see cref="ReadAsBinary" /> if you wish to
        ///     handle exceptions.
        /// </remarks>
