...
namespace DayZ2.DayZ2Launcher.App.Core
{
	public class Server : BindableBase, IEquatable<Server>
	{
		...
		public string Id => "[" + QueryHost + "]" + ":" + QueryPort;
		...
		public bool IsSameArmaAndDayZVersion => IsSameArma2OAVersion && IsSameDayZVersion;
		...
		public int? CurrentPlayers => GetSettingOrDefault("numplayers").TryIntNullable();

		public int? MaxPlayers => GetSettingOrDefault("maxplayers").TryIntNullable();
		...
		public string QueryHost => _queryHost;

		public ushort QueryPort => _queryPort;

		public string Mod => _mod;

		public string Password => _password;

		public int? Difficulty => GetSettingOrDefault("difficulty").TryIntNullable();
		...
		public bool IsEmpty => CurrentPlayers == null || CurrentPlayers == 0;
		...
		public string Notes
		{
			get => UserSettings.Current.GetNotes(this);
			set
			{
		...
		public bool HasPassword => GetSettingOrDefault("password").TryInt() > 0;
		...
		public bool ProtectionEnabled =>
			GetSettingOrDefault("verifySignatures").TryInt() > 0
