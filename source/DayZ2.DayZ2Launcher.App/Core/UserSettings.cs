...
namespace DayZ2.DayZ2Launcher.App.Core
{
    ...
    public class UserSettings
    {
        ...
        private static string _contentLastExtractionHashesPath;
        ...
        public static string ContentLastExtractionHashesPath
        {
            get
            {
                if (_contentLastExtractionHashesPath == null)
                {
                    _contentLastExtractionHashesPath = Path.Combine(ContentPath, "lastExtractionHashes.json");
                }
                return _contentLastExtractionHashesPath;
            }
        }
