...
namespace DayZ2.DayZ2Launcher.App.Core
{
	public class LauncherUpdater : BindableBase
	{
		...
		public Task CheckForUpdateAsync(CancellationToken cancellationToken)
		{
			if (ApplicationDeployment.IsNetworkDeployed)
			{
				...
				if (m_checkForUpdate == null)
				{
					...
					cancellationToken.Register(CheckForUpdateCancelled /*null*/);
		...
		//TODO: update .NET and uncomment cancellationToken
		void CheckForUpdateCancelled(/*object context, CancellationToken cancellationToken*/)
		{
			if (m_checkForUpdate != null)
			{
